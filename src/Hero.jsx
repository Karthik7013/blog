...
const Carousel = () => {
  ...
  function handleCreatPostModal(){
    if(login){
      document.getElementById('create_post').showModal()
    }else{
      navigate('/login')
    }
  }
...
<div className="hero min-h-dvh" style={{backgroundImage: 'url(https://img.freepik.com/free-photo/flat-lay-workstation-with-copy-space-laptop_23-2148430879.jpg?size=626&ext=jpg&ga=GA1.1.1887574231.1709251200&semt=ais)'}}>
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      ...
      <button className="btn text-xl font-light bg-[#dedddd]"  onClick={() => {handleCreatPostModal()}}>Create Post</button>
    </div>
  </div>
</div>
